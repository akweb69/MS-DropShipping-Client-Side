...
const OurStoryPage = () => {
  return (
    <>
      <Helmet>
        <title>আমাদের গল্প - TKDropShip</title>
        <meta name="description" content="TKDropShip এর পেছনের গল্প এবং আমাদের যাত্রার কথা জানুন।" />
      </Helmet>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            <div className="prose prose-lg max-w-none text-gray-700">
              <p>
                ২০২২ সালে কয়েকজন স্বপ্নবাজ উদ্যোক্তার হাত ধরে TKDropShip-এর যাত্রা শুরু হয়। আমাদের লক্ষ্য ছিল বাংলাদেশের ই-কমার্স জগতে একটি বিপ্লব আনা, যেখানে যে কেউ কোনো ইনভেন্টরি ছাড়াই নিজের ব্যবসা শুরু করতে পারে।
              </p>
              <p>
